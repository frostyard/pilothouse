...
func TestMultipathEnricherMarksCountMismatchDegraded(t *testing.T) {
	...
	assert.Contains(t, result.Resources, Resource{ID: stableID("mapping", "253:2"), Kind: "mapping", Name: "mpathb", Path: "/dev/mapper/mpathb", Health: HealthWarning, Details: []Detail{{Label: "MAJ:MIN", Value: "253:2"}, {Label: "Paths", Value: "1 of 2 observed"}}})
...
func TestMultipathEnricherLeavesUnknownPathStateUnknown(t *testing.T) {
	...
	assert.Contains(t, result.Resources, Resource{ID: stableID("mapping", "253:3"), Kind: "mapping", Name: "mpathc", Path: "/dev/mapper/mpathc", Health: HealthUnknown, Details: []Detail{{Label: "MAJ:MIN", Value: "253:3"}, {Label: "Paths", Value: "1 of 1 observed"}}})
}
